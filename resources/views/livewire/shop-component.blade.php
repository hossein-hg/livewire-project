                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('singleProduct',[$product->slug])}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                ...
                                <div class="product-info">
                                    ...
                                    <a href="#" class="btn add-to-cart" wire:click.prevent="addToCart({{$product->id}},'{{$product->name}}',{{(int)$product->regular_price}})">Add To Cart</a>
...
{{--                            </li>--}}
                            ...
                            <li class="category-item">
                                <a href="{{route('singleCategory',[$category->slug])}}" class="cate-link">{{$category->name}}</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
