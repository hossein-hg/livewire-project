            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if($product->sale_price > 0 and $sale->sale_date > \Carbon\Carbon::now() and $sale->status == 1)
                        ...
                        <div class="quantity">
                            ...
                            <div class="quantity-input">
                                <input wire:model="quantity" type="text" name="product-quatity"  data-max="120" pattern="[0-9]*" >

                                <a class="btn btn-reduce" wire:click="decrease()" href="#"></a>
                                <a class="btn btn-increase" wire:click="increase()" href="#"></a>
                            </div>
                        </div>
                        <div class="wrap-butons">
                            @if($product->sale_price > 0 and $sale->sale_date > \Carbon\Carbon::now() and $sale->status == 1)
                                <a wire:click.prevent="addToCart({{$product->id}},'{{$product->name}}',{{(int)$product->sale_price}})" href="#" class="btn add-to-cart">Add to Cart</a>
                            @else
                                <a wire:click.prevent="addToCart({{$product->id}},'{{$product->name}}',{{$product->regular_price}})" href="#" class="btn add-to-cart">Add to Cart</a>
                            @endif
                            @php
                            ...
                            <div class="wrap-btn">
                                ...
                                <a href="#" class="btn btn-wishlist" wire:click.prevent="removeFromWishlist({{$product->id}})">Remove Wishlist</a>
                                @else
                                    <a href="#" class="btn btn-wishlist" wire:click.prevent="addToWishlist({{$product->id}},'{{$product->name}}',{{(int)$product->regular_price}})">Add Wishlist</a>
                                @endif
                            </div>
                        </div>
                    </div>
