                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($order->status == 'ordered')
                                    <a href="#" wire:click.prevent="cancelOrderStatus()" class="btn btn-warning pull-right ">Cancel Order </a>
                                @endif
                            </div>
                        </div>
                    </div>
                                    ...
                                    <li class="pr-cart-item">
                                        <div class="product-image">
                                            <figure><img src="{{asset('assets/images/products/'.$item->product->image)}}"
                                                         width="100" height="90" alt=""></figure>
                                        </div>
                                        <div class="product-name">
                                            <a href="{{route('singleProduct',[$item->product->slug])}}"
                                               class="link-to-product">{{$item->product->name}}</a>
                                        </div>

                                        <div class="price-field product-price">
                                            <p class="price">{{$item->price}}</p>
                                        </div>
                                        <div class="price-field product-price"><p>{{$item->quantity}}</p></div>
                                        <div class="price-field product-price"><p>{{$item->price * $item->quantity}}</p> </div>
                                    </li>
